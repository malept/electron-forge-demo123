...
MakeCert.exe -n CN=ElectronForgeCI -r -h 0 -eku "1.3.6.1.5.5.7.3.3,1.3.6.1.4.1.311.10.3.13" -e 12/31/2050 -sv codesign.pvk codesign.cer

Pvk2Pfx.exe -pvk codesign.pvk -spc codesign.cer -pfx codesign.pfx
